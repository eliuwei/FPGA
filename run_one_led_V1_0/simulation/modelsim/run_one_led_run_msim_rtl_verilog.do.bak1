...
vlog -vlog01compat -work work +incdir+E:/quartus_Project/run_one_led/source {E:/quartus_Project/run_one_led/source/run_one_led.v}

vlog -vlog01compat -work work +incdir+E:/quartus_Project/run_one_led/simulation/modelsim {E:/quartus_Project/run_one_led/simulation/modelsim/run_one_led.vt}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  run_one_led_vlg_tst
